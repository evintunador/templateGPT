...
class ModelConfig:
    ...
    norm_type: str = 'LayerNorm' # options are 'RMSNorm'(recommended), 'LayerNorm', and 'CosineNorm'. Add more options in 'model.py'
...
class TrainConfig:
    ...
    model_name = 'customGPT_5m'#f'{time.strftime("%Y-%m-%d|%H-%M-%S")}'
    
    weight_decay: float = 0.05
    batch_size: int = 32
    
    # total number of batches to run over the course of training
    max_iters: int = 50#5_000 # i recommend at least 1_000
